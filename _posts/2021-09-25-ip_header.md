...
{% include gallery id="layouts_gallery_5" caption="**Схема**" %}

С помощью расширенной программы *ping* на маршрутизаторах Cisco можно найти максимальный MTU между устройствами. 
...
Из вывода видно, что максимальный MTU равен 1500 байт. Существуют и другие способы как с помощью данной команды найти максимальный MTU между группой сетевых устройств, но данный способ сейчас рассматривать не будем.
